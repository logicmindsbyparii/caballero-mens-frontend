          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-white/60 text-sm">Shop no - 137, TIMES WORLD, Bhimrad-Althan Rd, Althan, Surat, Gujarat 395007
                </span>
              </li>
              <li className="flex items-center gap-3">
                <Phone size={15} className="text-brown shrink-0" />
                <a href="tel:+91 96244 53722" className="text-white/60 text-sm hover:text-white transition-colors">+91 98765 43210</a>
              </li>
              <li className="flex items-center gap-3">
