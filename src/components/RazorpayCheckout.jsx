...
const RazorpayCheckout = ({ amount, onSuccess, onError }) => {
  ...
  const paymentMethods = [
    ...
    { id: 'wallet',     label: 'Wallets',                 desc: 'Paytm, Mobikwik, Freecharge', icon: <Wallet size={22} color="#8B4513" /> },
  ];
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', marginBottom: '12px' }}>
                        {wallets.map((w) => (
                          <div
                            ...
                            style={{
                              padding: '12px 8px', borderRadius: '10px', cursor: 'pointer', fontSize: '12px',
                              fontWeight: selectedWallet === w ? '700' : '500', textAlign: 'center',
                              border: `1.5px solid ${selectedWallet === w ? '#8B4513' : '#e0d0c0'}`,
                              background: selectedWallet === w ? '#fdf8f0' : '#fafafa',
                              color: selectedWallet === w ? '#8B4513' : '#444',
                              transition: 'all 0.15s',
                            }}
                          >
                            {w}
